...
class MyAgent(BaseAgent):
    ...
    def compare_with_model_2(self, act, rwd):
        if rwd > 0:
            return act
        chosen_action, chosen_rwd, action_index = self.backupAgent.get_action_by_model_2()
        #if chosen_action is not None and chosen_rwd > rwd:
    ...
    def act(self, observation, reward, done):
        ...
        if max_value < activateAgentRho:
            ...
            chosen_action = self.compare_with_model_2(action_topo, rwd_topo)          # the random aspect comes in here
            return chosen_action
