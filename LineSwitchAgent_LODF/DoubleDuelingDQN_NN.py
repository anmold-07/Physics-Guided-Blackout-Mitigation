...
class DoubleDuelingDQN_NN(object):
    ...
    def construct_q_network(self):
        ...
        lay1 = tfkl.Dense(self.observation_size, name="fc_1")(input_layer)
        lay1 = tfka.tanh(lay1)

        lay3 = tfkl.Dense(self.action_size, name="fc_3")(lay1)        
        lay3 = tfka.tanh(lay3)

        lay4 = tfkl.Dense(self.action_size, name="fc_4")(lay3)        
        lay4 = tfka.tanh(lay4)

        #
        advantage = tfkl.Dense(self.action_size, name="fc_adv")(lay4)  
        advantage = tfka.tanh(advantage) 
        ...
        value = tfkl.Dense(self.action_size, name="fc_val")(lay4)      
        value = tfka.tanh(value)
